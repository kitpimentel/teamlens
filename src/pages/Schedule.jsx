...
export default function Schedule() {
  ...
  const [events, setEvents] = useState([
    { id: 1, title: "Team Standup", date: "March 4", time: "9:00 AM", endTime: "9:30 AM", attendees: 8, type: "recurring", location: "Meeting Room A" },
    { id: 2, title: "Project Alpha Review", date: "March 5", time: "2:00 PM", endTime: "3:00 PM", attendees: 5, type: "meeting", location: "Conference Room" },
    { id: 3, title: "Client Presentation", date: "March 8", time: "11:00 AM", endTime: "12:30 PM", attendees: 3, type: "external", location: "Zoom" },
    { id: 4, title: "Sprint Planning", date: "March 10", time: "10:00 AM", endTime: "11:30 AM", attendees: 6, type: "planning", location: "Meeting Room B" },
    { id: 5, title: "Quarterly Review", date: "March 15", time: "3:00 PM", endTime: "4:30 PM", attendees: 12, type: "review", location: "Auditorium" },
    { id: 6, title: "Team Building", date: "March 25", time: "1:00 PM", endTime: "5:00 PM", attendees: 15, type: "event", location: "City Park" }
  ]);
  ...
  const calendarDays = Array.from({ length: 35 }, (_, i) => {
    ...
    return { day: day > 0 && day <= 31 ? day : null, hasEvents: [4, 5, 8, 10, 15, 25].includes(day) };
  });
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header username="Sergey Goldberg" currentPage="Schedule" />
                    ...
                    {events.map(event => (
                      <div key={event.id} className="flex border-b pb-4 last:border-0 last:pb-0">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-500">{event.time} - {event.endTime} • {event.attendees} attendees</div>
